...
#top {
            background-image: url('https://i.etsystatic.com/42677351/r/il/481e08/4807085130/il_1080xN.4807085130_1bnq.jpg');
            background-size: cover;
            background-position: center;
        }
    </style>
...
<section class="heading-page header-text" id="top">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2 style="color:#4b5403">Update Quiz</h2>
                    ...
                    <div class="col-lg-12">
                        <div class="meeting-single-item">
                            <div class="down-content" style="margin-top:-100px">
                               <h3 style="text-align:center">Update Quiz</h3>
                               <s:form id="f1" action="updatequiz" theme="simple">
                               <%
                                @SuppressWarnings("unchecked")
                                ArrayList<Quiz> clist = (ArrayList<Quiz>) session.getAttribute("quizlist");
                                if (clist != null && !clist.isEmpty()) {
                                    String id = request.getParameter("id");
                                    if (id != null && !id.isEmpty()) { 
                                        for (Quiz cc : clist) {
                                            if (cc.getId() == Integer.parseInt(id)) { 
                               ...
                               <input type="hidden" name="btn" value="<%= cc.getCtype() %>">
                               	...
                               	<table style="width:90%; margin-top:30px">
                               		<tr>
                               			<td>Question</td>
                               			<td><input type="text" name="question" class="txt" value="<%= cc.getQuestion() %>"></td>
                               			<td><s:fielderror fieldName="question" style="color:red"/></td>
                               		</tr>
                               		
                               		<tr>
                               			<td>Option1</td>
                               			<td><input type="text" name="option1" class="txt" value="<%= cc.getOption1() %>"></td>
                               			<td><s:fielderror fieldName="option1" style="color:red"/></td>
                               		</tr>
                               		
                               		<tr>
                               			<td>Option2</td>
                               			<td><input type="text" name="option2" class="txt" value="<%= cc.getOption2() %>"></td>
                               			<td><s:fielderror fieldName="option2" style="color:red"/></td>
                               		</tr>
                               		
                               		<tr>
                               			<td>Option3</td>
                               			<td><input type="text" name="option3" class="txt" value="<%= cc.getOption3() %>"></td>
                               			<td><s:fielderror fieldName="option3" style="color:red"/></td>
                               		</tr>
                               		<tr>
                               			<td>Option4</td>
                               			<td><input type="text" name="option4" class="txt" value="<%= cc.getOption4() %>"></td>
                               			<td><s:fielderror fieldName="option4" style="color:red"/></td>
                               		</tr>
                               		
                               		<tr>
                               			<td>Correct Option</td>
                               			<td><input type="text" name="coption" class="txt" value="<%= cc.getCoption() %>"></td>
                               			<td><s:fielderror fieldName="coption" style="color:red"/></td>
                               		</tr>
                               		
                               		<tr>
                               			<td>Level</td>
                               			<td><input type="text" name="level" class="txt" value="<%= cc.getLevel() %>" readonly style="color:#8a817f"></td>
                               	...
                               	%>
                    				...
                    				<input type="submit" value="Update Quiz" class="btn" style="margin-top:20px; border-radius:50px; width:20%; height:40px; background:#a12c2f; color:white">
                <div class="main-button-red">
                    <a href="/DigitalAcademy/view/ViewSelectedQuiz.jsp">Cancel </a>
                </div>
                </div>
            </div>
