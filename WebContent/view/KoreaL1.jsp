                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12"  >
                            <div class="main-button-red"  style="margin-left:85%; margin-top:50px;width:300px;height:60px;">
                                <a href="/DigitalAcademy/view/KoreaHome2.jsp">Back to Korea Course</a>
                            </div>
                        </div>
                    </div>
                     <div class="col-lg-6" style="margin-top:-100px">
                <img src="https://i.pinimg.com/736x/2c/fb/0c/2cfb0c36047c9bf92b4dd227b0ee020f.jpg" alt="Image" class="section-image" style="width: 100%; height: 750px;">
            </div>
                </div>
