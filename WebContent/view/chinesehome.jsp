...
<head>
    ...
    <style>
       #top {
            background-image: url('https://images.alphacoders.com/132/1326366.png');
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="main-button-red">
                                <a href="/DigitalAcademy/view/subject.jsp">Back To Courses</a>
                            </div>
                        </div>
                    </div>
                </div>
