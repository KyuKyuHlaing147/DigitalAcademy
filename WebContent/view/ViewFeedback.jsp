                    ...
                    <div class="col-lg-16">
                        <div class="meeting-single-item">
                            <div class="down-content" style="margin-top:-100px">
                                ...
                                <%
                                ArrayList<FeedBack> qlist = (ArrayList<FeedBack>) session.getAttribute("flist");
                                if (qlist != null && !qlist.isEmpty()) {
                                %>
                                <div class="table-responsive">
    							<div class="row" style="margin-top: 20px;margin-bottom: 20px;">
        						<div class="col-lg-12" style="margin-bottom: 20px;" >
            						<table id="contentTable"  style="font-size:13px; font-weight:bold; padding-top:10px; width:90%; border:1px solid ; margin-bottom:20px; margin-top:20px">
                  ...
                  <thead>
                                            ...
                                            <tr>
                                                ...
                                                <td><%= ff.getFeedback() %></td>
                                                 <td>
												    <a href="/DigitalAcademy/action/deletefeedback1.action?id=<%=ff.getFid() %>"
												       class="delete-link"
