...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        <% String found = (String)session.getAttribute("update1");
...
<section class="heading-page header-text" id="top">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2 style="color:#5c048f">View Schedule</h2>
        ...
        <div class="col-lg-12" style="margin-bottom: 20px;">
            <table id="contentTable" style="font-size:13px; font-weight:bold; padding-top:10px; border:1px solid; ">
                ...
                <tbody>
                    ...
                    // Iterate through the sorted ArrayList
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/DigitalAcademy/view/scheduleupdateform.jsp?name=<%= ss.getName() %>"
                                class="update-link" style="color:blue">Update</a>
                        </td>

                        <td>
                            <a href="/DigitalAcademy/action/deleteschedule.action?name=<%= ss.getName() %>"
                                class="delete-link" style="color:blue">Delete</a>
                        </td>
                    </tr>
                    <% } %>
                </tbody>
