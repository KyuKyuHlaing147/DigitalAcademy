...
<head>
    ...
    <style>
       #top {
            background-image: url('https://static.vecteezy.com/system/resources/previews/026/858/409/non_2x/of-a-laptop-computer-on-a-vibrant-pink-desk-with-plenty-of-room-for-creativity-with-copy-space-free-photo.jpg');
   ...
   <header class="header-area header-sticky" style="background-color:white;color:black;">
    ...
    <section class="heading-page header-text" id="top">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2 style="color:black">Chinese Courses</h2>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="meeting-single-item">
                                ...
                                <div class="down-content" style="background:#e8cdb0; margin-top:-100px">
                                  <h4>Available Chinese Course</h4>
                                  
                                  
                                 <div class="image-container">
                                    <div class="dd1" style="text-align:center;">
                                    
                                     <form action="Chinese1" method="get">
									    <input type="hidden" name="uname" value=<%= name %>>
									    <button type="submit" style="background: none; border: none; padding: 0; margin: 0;">
								      <img src="https://m.media-amazon.com/images/I/51wcbXHM5tL._AC_UF1000,1000_QL80_.jpg" class="img">
									    </button>
									</form>
                                    
                                    <br>
                              
                                   		  <form action="Chinese1" method="post">
                                   		  <input type="hidden" name="uname" value=<%= name %>>
                                    ...
                                    <div class="dd1" style="text-align:center;">
                                     ...
                                     <form action="Chinese2" method="get">
									    <input type="hidden" name="uname" value=<%= name %>>
									    <button type="submit" style="background: none; border: none; padding: 0; margin: 0;">
								      <img src="https://m.media-amazon.com/images/I/51prWDGGQNL._AC_UF1000,1000_QL80_.jpg" class="img">
									    </button>
									</form>
                                       <br>
                                   		 <form action="Chinese2" method="post">
                                   		 <input type="hidden" name="uname" value=<%= name %>>
            								<button type="submit" style="background: none; border: none; padding: 0; font: inherit; color: black; text-decoration: none; cursor: pointer;">
								              <h5>HSK 2</h5>
								            </button>
                                    ...
                                    <div class="dd1" style="text-align:center;">
                                       ...
                                       <form action="Chinese3" method="get">
									    <input type="hidden" name="uname" value=<%= name %>>
									    <button type="submit" style="background: none; border: none; padding: 0; margin: 0;">
								      <img src="https://m.media-amazon.com/images/I/81sR2V8UC9L._AC_UF1000,1000_QL80_.jpg" class="img">
									    </button>
									</form>
                                        <br>
                                   		 <form action="Chinese3" method="post">
                                   		 <input type="hidden" name="uname" value=<%= name %>>
            								<button type="submit" style="background: none; border: none; padding: 0; font: inherit; color: black; text-decoration: none; cursor: pointer;">
								              <h5>HSK 3</h5>
								            </button>
                                    ...
                                    <div class="dd1" style="text-align:center;">
                                      <form action="Chinese4" method="get">
									    <input type="hidden" name="uname" value=<%= name %>>
									    <button type="submit" style="background: none; border: none; padding: 0; margin: 0;">
								      <img src="https://m.media-amazon.com/images/I/81qFWWhvv1L._SY466_.jpg" class="img">
									    </button>
									</form>
                                      
                                        <br>
                                   		  <form action="Chinese4" method="post">
                                   		  <input type="hidden" name="uname" value=<%= name %>>
            								<button type="submit" style="background: none; border: none; padding: 0; font: inherit; color: black; text-decoration: none; cursor: pointer;">
								              <h5>HSK 4</h5>
								            </button>
                                    ...
                                    <div class="dd1" style="text-align:center;">
                                        ...
                                        <form action="Chinese5" method="get">
									    <input type="hidden" name="uname" value=<%= name %>>
									    <button type="submit" style="background: none; border: none; padding: 0; margin: 0;">
								      <img src="https://1.bp.blogspot.com/-kb2JhTqzvtQ/YOLHtMHzFeI/AAAAAAAAABM/1iRoSLsWQXwZ9fKuhSPLTE04Ob_gB3VVQCLcBGAsYHQ/s977/IMG_20210705_134829.jpg" class="img">
									    </button>
									</form>
                                       <br>
                                   		<form action="Chinese5" method="post">
                                   		<input type="hidden" name="uname" value=<%= name %>>
            								<button type="submit" style="background: none; border: none; padding: 0; font: inherit; color: black; text-decoration: none; cursor: pointer;">
								              <h5>HSK 5</h5>
								            </button>
                                    ...
                                    <div class="dd1" style="text-align:center;">
                                        ...
                                        <form action="Chinese6" method="get">
									    <input type="hidden" name="uname" value=<%= name %>>
									    <button type="submit" style="background: none; border: none; padding: 0; margin: 0;">
								      <img src="https://m.media-amazon.com/images/I/61gloCObOIL._SY466_.jpg" class="img">
									    </button>
									</form>
                                       <br>
                                   		<form action="Chinese6" method="post">
                                   		<input type="hidden" name="uname" value=<%= name %>>
            								<button type="submit" style="background: none; border: none; padding: 0; font: inherit; color: black; text-decoration: none; cursor: pointer;">
								              <h5>HSK 6</h5>
								            </button>
                        ...
                        <div class="col-lg-12">
                            <div class="main-button-red">
                                <a href="/DigitalAcademy/view/subject2.jsp">Back To Courses</a>
                            </div>
                        </div>
                    </div>
                </div>
