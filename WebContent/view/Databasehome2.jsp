   ...
   <header class="header-area header-sticky" style="background-color:white;color:black;">
    ...
    <section class="heading-page header-text" id="top">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2 style="color:black">Database Courses</h2>
                        ...
                        <div class="col-lg-12">
                            <div class="meeting-single-item">
                                ...
                                <div class="down-content" style="margin-top:-100px; background: linear-gradient(90deg, rgba(212,214,119,1) 0%, rgba(191,237,94,1) 53%, rgba(74,125,120,1) 99%);">
                                  <h4>Available Database Course</h4>
                                  
                                  
                                 <div class="image-container" >
                                    <div class="dd1" style="text-align:center; margin-left:150px;">
                                        <form action="DBTBeginner" method="get">
									    <input type="hidden" name="uname" value=<%= name %>>
									    <button type="submit" style="background: none; border: none; padding: 0; margin: 0;">
									         <img src="https://cdn.shopify.com/s/files/1/0329/9547/5515/products/9789355510266_600x.jpg?v=1652353982" class="img">
									    </button>
									</form>
                                       
                                      <br>
                                   		  <form action="DBTBeginner" method="post">
                                   		   <input type="hidden" name="uname" value=<%= name %>>
                                    ...
                                    <div class="dd1" style="text-align:center;margin-left:50px">
                                        ...
                                        <form action="DBTInter" method="get">
									    <input type="hidden" name="uname" value=<%= name %>>
									    <button type="submit" style="background: none; border: none; padding: 0; margin: 0;">
									          <img src="https://d3s9yd6qcwjotm.cloudfront.net/Content/Publisher/64899/training_material/12793/TCR0Pq.jpg" class="img">
									    </button>
									</form>
                                         <br>
                                   		 <form action="DBTInter" method="post">
                                   		  <input type="hidden" name="uname" value=<%= name %>>
            								<button type="submit" style="background: none; border: none; padding-left: 20px; font: inherit; color: black; text-decoration: none; cursor: pointer;">
								              <h5>Intermediate</h5>
								            </button>
                                    ...
                                    <div class="dd1" style="text-align:center;margin-left:50px">
                                         <form action="DBTAdvance" method="get">
									    <input type="hidden" name="uname" value=<%= name %>>
									    <button type="submit" style="background: none; border: none; padding: 0; margin: 0;">
									          <img src="https://cdn.educba.com/academy/wp-content/uploads/2023/05/Advanced-Database-Management-System-230x300.png" class="img">
									    </button>
									</form>
                                        
                                        <br>
                                   		 <form action="DBTAdvance" method="post">
                                   		  <input type="hidden" name="uname" value=<%= name %>>
            								<button type="submit" style="background: none; border: none; padding-left: 20px; font: inherit; color: black; text-decoration: none; cursor: pointer;">
								              <h5>Advance</h5>
								            </button>
