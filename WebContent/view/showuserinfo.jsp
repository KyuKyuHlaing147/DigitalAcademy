...
<head>
    ...
    <style>
        #top {
            background-image: url('https://www.business2community.com/wp-content/uploads/2020/12/8-principles-background-01-2.png');
...
<section class="heading-page header-text" id="top">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2 style="color:#a83f07">User Information</h2>
                ...
                <div class="row">
                    <div class="col-lg-16">
                        <div class="meeting-single-item">
                            <div class="down-content" style="margin-top:-100px">
                                ...
                                <%
                                ArrayList<UserProfile> qlist = (ArrayList<UserProfile>) session.getAttribute("plist");
                  ...
                  <thead>
                                            ...
                                            <tr>
                                                ...
                                                <td><%= qq.getZip() %></td>
                                               <td>
												    <a href="/DigitalAcademy/action/deleteuser.action?id=<%=qq.getId() %>&name=<%= qq.getUsername() %>"
												       class="delete-link"
