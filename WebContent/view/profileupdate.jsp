                          ...
                          <li class="has-sub">
                              ...
                              <ul class="sub-menu">
                                 <li><a href="<s:url action='showprofile'/>" style="color:black; font-weight:bold">Profile</a></li>
                                  <li><a href="<s:url action='LogoutAction'/>" style="color:black; font-weight:bold">Logout</a></li>
...
<!-- ***** Menu End ***** -->
    ...
    <section class="heading-page header-text" id="top">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h6 style="color:black">Korean Courses</h6>
                    <h2 style="color:black">Online Teaching and Learning Tools</h2>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="meetings-page" id="meetings">
                ...
                <div class="col-lg-12">
                    <div class="meeting-single-item" style="justify-content: center; align-items: center; display: flex;">
                        <div class="down-content" style="border-radius:10px; margin-top:-100px; width:90%; background-image: url('https://i.pinimg.com/564x/1b/d2/50/1bd250a2a4cdf9e3747b54299e7befa4.jpg'); background-size: cover;">
                            ...
                            <s:form theme="simple" action="UpdateProfile" enctype="multipart/form-data">
                                <table style="margin-left: 30px; margin-top: 40px; width: 80%; margin: 10px auto">
                                   ...
                                   <tr>
            <td>Username:</td>
            <td><input type="text" name="username" value="<%= userProfile.getUsername() %>" class="txt"></td>
        ...
        <tr>
            <td>Date of Birth:</td>
            <td><input type="date" name="dob" value="<%= userProfile.getDob() %>" class="txt"></td>
            <td><s:fielderror fieldName="dob" cssClass="error"></s:fielderror></td>
        </tr>
        <tr>
            <td>Gender:</td>
            <td>
                <input type="radio" name="gender" value="Male" <% if (userProfile.getGender().equals("Male")) out.print("checked"); %>> Male
                <input type="radio" name="gender" value="Female" <% if (userProfile.getGender().equals("Female")) out.print("checked"); %>> Female
            </td>
            <td><s:fielderror fieldName="gender" cssClass="error"></s:fielderror></td>
        </tr>
        <tr>
            <td>Email:</td>
            <td><input type="email" name="email" value="<%= userProfile.getEmail() %>" class="txt"></td>
            <td><s:fielderror fieldName="email" cssClass="error"></s:fielderror></td>
        </tr>
        <tr>
            <td>Telephone:</td>
            <td><input type="tel" name="telephone" value="<%= userProfile.getPhone() %>" class="txt"></td>
            <td><s:fielderror fieldName="telephone" cssClass="error"></s:fielderror></td>
        </tr>
        <tr>
            <td>Country:</td>
            <td>
                <select name="country" class="txt">
                    <option value="Myanmar" <% if (userProfile.getCountry().equals("Myanmar")) out.print("selected"); %>>Myanmar</option>
                    <option value="Korea" <% if (userProfile.getCountry().equals("Korea")) out.print("selected"); %>>Korea</option>
                    <option value="China" <% if (userProfile.getCountry().equals("China")) out.print("selected"); %>>China</option>
                    <option value="Thailand" <% if (userProfile.getCountry().equals("Thailand")) out.print("selected"); %>>Thailand</option>
                </select>
            </td>
            <td><s:fielderror fieldName="country" cssClass="error"></s:fielderror></td>
        </tr>
        <tr>
            <td>Zip:</td>
            <td><input type="text" name="zip" value="<%= userProfile.getZip() %>" class="txt"></td>
            <td><s:fielderror fieldName="zip" cssClass="error"></s:fielderror></td>
        </tr>
        <tr>
            <td>Profile Picture:</td>
            <td><input type="file" name="pictureFile" class="txt"></td>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <div style="justify-content: center; align-items: center; display: flex;">
                                                <input type="hidden" name="uname" value="<%= userProfile.getUsername() %>">
                                                <input type="hidden" name="email" value="<%= userProfile.getEmail() %>">
    ...
    function redirectToProfilePage() {
        window.location.href = "/DigitalAcademy/view/profile.jsp";
    }
