...
<head>
    ...
    <style>
          #top {
            background-image: url('https://static-cse.canva.com/blob/570979/zoombackgroundsbanner.b51cb900.png');
                      ...
                      <ul class="nav">
                        ...
                        <li class="has-sub">
                              ...
                              <ul class="sub-menu">
                                  ...
                                  <li><a href="<s:url action='LogoutAction2'/>" style="color:black; ">Log Out</a></li>
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        <% String found = (String)session.getAttribute("update2");
...
<section class="heading-page header-text" id="top">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2 style="color:#8f0445">View Quiz</h2>
        ...
        <div class="row">
                ...
                <div class="row">
                  ...
                  <thead>
                                            ...
                                            <tr>
                                                ...
                                                <td><%= qq.getCtype() %></td>
                                                <td>
												    <a href="/DigitalAcademy/view/showquizform.jsp?id=<%= qq.getId() %>"
												       class="update-link" data-id="<%= qq.getId() %>"
												       style="color:blue">Update</a>
												</td>
												<td>
													    <a href="/DigitalAcademy/action/deletequiz.action?id=<%= qq.getId() %>&btn=<%= qq.getCtype() %>"
													       class="delete-link" data-id="<%= qq.getId() %>"
            ...
            <div class="col-lg-12">
                <div class="main-button-red">
                    <a href="/DigitalAcademy/view/AdminShowQuiz.jsp">Back To Quiz Contents</a>
                </div>
            </div>
        </div>
    </div>
