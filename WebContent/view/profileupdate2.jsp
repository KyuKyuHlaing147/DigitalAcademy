...
%>
       ...
       <table style="margin-left: 30px; margin-top: 40px; width: 80%; margin: 10px auto">
        <tr>
            <td>UserName:</td>
            <td><input type="text" name="username" value="<%= user != null ? user.getUsername() : "" %>"  class="txt"/></td>
            <td><s:fielderror fieldName="username" cssClass="error"/></td>
        </tr>
        <tr>
            <td>Old Password:</td>
            <td><input type="password" name="opassword" class="txt"/></td>
            <td><s:fielderror fieldName="opassword" cssClass="error"/></td>
        </tr>
        <tr>
            <td>New Password:</td>
        ...
        <tr>
            <td>Date of Birth:</td>
            <td><input type="date" name="dob" value="<%= user != null ? user.getDob() : "" %>" class="txt"/></td>
            <td><s:fielderror fieldName="dob" cssClass="error"/></td>
        </tr>
        <tr>
            <td>Gender:</td>
            <td>
                <input type="radio" name="gender" value="Male" <%= user != null && user.getGender().equals("Male") ? "checked" : "" %>/> Male
                <input type="radio" name="gender" value="Female" <%= user != null && user.getGender().equals("Female") ? "checked" : "" %>/> Female
            </td>
            <td><s:fielderror fieldName="gender" cssClass="error"/></td>
        </tr>
        <tr>
            <td>Email:</td>
            <td><input type="email" name="email" value="<%= user != null ? user.getEmail() : "" %>" class="txt"/></td>
            <td><s:fielderror fieldName="email" cssClass="error"/></td>
        </tr>
        <tr>
            <td>Telephone:</td>
            <td><input type="tel" name="telephone" value="<%= user != null ? user.getPhone() : "" %>" class="txt"/></td>
        ...
        <tr>
            ...
            <td>
                <select name="country" class="txt">
                    <option value="Choose country" <%= user != null && user.getCountry().equals("Choose country") ? "selected" : "" %>>Choose country</option>
                    <option value="Myanmar" <%= user != null && user.getCountry().equals("Myanmar") ? "selected" : "" %>>Myanmar</option>
                    <option value="Korea" <%= user != null && user.getCountry().equals("Korea") ? "selected" : "" %>>Korea</option>
                    <option value="China" <%= user != null && user.getCountry().equals("China") ? "selected" : "" %>>China</option>
                    <option value="Thailand" <%= user != null && user.getCountry().equals("Thailand") ? "selected" : "" %>>Thailand</option>
                </select>
            </td>
        ...
        <tr>
            <td>Zip:</td>
            <td><input type="text" name="zip" value="<%= user != null ? user.getZip() : "" %>" class="txt"/></td>
