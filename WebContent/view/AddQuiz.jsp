...
#top {
            background-image: url('https://wallpapercave.com/wp/wp4297922.jpg');
            background-size: cover;
            background-position: center;
        }
    </style>
...
<section class="heading-page header-text" id="top">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2 style="color:#8f0707">Add New Quiz</h2>
                    ...
                    <div class="col-lg-12">
                        <div class="meeting-single-item">
                            <div class="down-content" style="background: none; margin-top:-130px" >
                               <h3 style="text-align:center">Add New Quiz</h3>
                               <s:form id="f1" action="Addnewquiz" theme="simple" style="border:1px solid; width:80%; border-radius:10px; ">
                               	<table style="width:90%; margin-top:30px; margin-left:40px">
                               		<tr>
                               			<td style="font-weight:bold">Question</td>
                               			<td><input type="text" name="question" class="txt" placeholder="Enter Question"></td>
                               			<td><s:fielderror fieldName="question" style="color:red"/></td>
                               		</tr>
                               		
                               		<tr>
                               			<td style="font-weight:bold">Option1</td>
                               			<td><input type="text" name="option1" class="txt" placeholder="Enter Option1"></td>
                               			<td><s:fielderror fieldName="option1" style="color:red"/></td>
                               		</tr>
                               		
                               		<tr>
                               			<td style="font-weight:bold">Option2</td>
                               			<td><input type="text" name="option2" class="txt" placeholder="Enter Option2"></td>
                               			<td><s:fielderror fieldName="option2" style="color:red"/></td>
                               		</tr>
                               		
                               		<tr>
                               			<td style="font-weight:bold">Option3</td>
                               			<td><input type="text" name="option3" class="txt" placeholder="Enter Option3"></td>
                               			<td><s:fielderror fieldName="option3" style="color:red"/></td>
                               		</tr>
                               		<tr>
                               			<td style="font-weight:bold">Option4</td>
                               			<td><input type="text" name="option4" class="txt" placeholder="Enter Option4"></td>
                               		...
                               		<tr>
                               			...
                               			<select name="coption" class="txt" style="background-color:white" >
                               		...
                               		<tr>
                               			...
                               			<input type="text" name="levellabel" class="txt" placeholder="Choose Level"  readonly value="Choose Level">
