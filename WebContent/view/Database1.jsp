            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="main-button-red" style="margin-left:85%; margin-top:50px;width:350px;height:60px;">
                                <a href="/DigitalAcademy/view/Databasehome2.jsp">Back to Database Course</a>
                            </div>
                        </div>
                    </div>
                     <div class="col-lg-6" style="margin-top:-100px;">
                <img src="https://insight.ng/wp-content/uploads/2023/06/InShot_20230617_080352634.jpg" alt="Image" class="section-image" alt="Image" class="section-image" style="width: 100%; height: 730px;">
            </div>
                </div>
