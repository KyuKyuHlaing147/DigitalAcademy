...
<link rel="icon" href="${pageContext.request.contextPath}/assets2/images/D (3).png" type="image/x-icon"> 
    <!-- Bootstrap core CSS -->
...
<link href="https://fonts.googleapis.com/css2?family=Abril+Fatface&family=DM+Serif+Display:ital@0;1&family=Dancing+Script:wght@400..700&family=Permanent+Marker&family=Roboto+Slab:wght@100..900&family=Rubik+Scribble&display=swap" rel="stylesheet">
  </head>
  <style>
  		.di1{
...
@-webkit-keyframes Gradient {
 ...
 #contact{
 background: linear-gradient(0deg, rgba(100,198,208,1) 33%, rgba(255,218,193,1) 100%);
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="owl-courses-item owl-carousel">
            <div class="item">
            <a href="showfeedback?course=Korean">
              <img src="${pageContext.request.contextPath}/assets/images/korera.jpg" alt="Course One">
              </a>
              <div class="down-content">
              <h4 style="color:darkcyan;"> <a href="showfeedback?course=Korean"  style="color:darkcyan;" >Korea Language</a></h4>
              </div>
            </div>
            <div class="item">
            <a href="showfeedback?course=Japanese">
              <img src="${pageContext.request.contextPath}/assets/images/japannew.jpg" alt="Course Two">
             </a> 
              <div class="down-content">
                 <h4 style="color:darkcyan;"> <a href="showfeedback?course=Japanese"  style="color:darkcyan;">Japanese Language</a></h4>
              </div>
            </div>
            <div class="item">
            <a href="showfeedback?course=Chinese">
              <img src="${pageContext.request.contextPath}/assets/images/images.png" alt="">
             </a>
              <div class="down-content">
                <h4 > <a href="showfeedback?course=Chinese"  style="color:darkcyan;">Chinese Language</a></h4>
               
              </div>
            </div>
            <div class="item">
            
              <a href="showfeedback?course=Cpp">
    			<img src="${pageContext.request.contextPath}/assets/images/se.jpg" alt="">
			</a>

              <div class="down-content">
                 <h4 > <a href="showfeedback?course=Cpp" style="color:darkcyan;">C++ Language</a></h4>
              </div>
            </div>
            <div class="item">
            <a href="showfeedback?course=Database">
              <img src="${pageContext.request.contextPath}/assets/images/oracle2.jpg" alt="">
              </a>
              <div class="down-content">
              <h4 > <a href="showfeedback?course=Database" style="color:darkcyan;">Database Language</a></h4>
            ...
            <div class="col-lg-12">
              <form id="contact" action="message" method="post">
                <div class="row">
                  ...
                  <div class="col-lg-12">
                    <fieldset>
                      <textarea name="feedback" class="form-control" id="message" placeholder="YOUR FEEDBACK..." required></textarea>
                    </fieldset>
                  </div>
                  <div class="col-lg-12">
                    <fieldset>
