...
Content cc = onelist2.get(i);

if (cc.getName().equals(cname)) {
...
<h4><%= cc.getCtype() %> <%= cc.getLevel() %></h4><br>

<h4>Title : <%=cc.getName() %></h4>

<br>

<h5>About: <%=cc.getAbout() %></h5>
...
<a href="#" class="download-link" data-ppt-url="${pageContext.request.contextPath}<%=cc.getPpt() %>">Download PowerPoint</a>



<form action="increase" style="margin-top:5px;">

<input type="hidden" value="<%=cc.getCid() %> " name="cid">

<input type="hidden" value="<%= cc.getCtype() %>" name="ctype">

<input type="hidden" value="<%= cc.getLevel() %>" name="level">

<% if (i == onelist2.size() - 1) { %>

 <input type="submit" name="finish" value="Done" style="background: #a12c2f; color:white; border-radius:50px; width:140px; height:40px; padding: 0; font: inherit; text-decoration: none;margin-left:73%;cursor: pointer;">
<% } else { %>

 <input type="submit" name="finish" value="Next Lesson" style="background: #a12c2f; color:white; border-radius:50px; width:140px; height:40px; padding: 0; font: inherit; text-decoration: none;margin-left:73%;cursor: pointer;">
<% } %>
...
<form action="TakeExam" style="margin-top:5px;">
