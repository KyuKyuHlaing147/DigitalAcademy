                    ...
                    <div class="col-lg-16">
                        <div class="meeting-single-item">
                            <div class="down-content">
                                ...
                                <%
                                ArrayList<Quiz> qlist = (ArrayList<Quiz>) session.getAttribute("quizsearchlist");
                                    ...
                                    <div class="col-lg-12">
                                        <table class="table table-bordered" style="font-size:14px; font-weight:bold">
                                            ...
                                            <tr>
                                                ...
                                                <td><%= qq.getLevel() %></td>
                                                <td><%= qq.getCtype() %></td>
                                                <td> <a href="showquizform.jsp?id=<%= qq.getId() %>"  style="color:blue">Update</a></td>
                                                <td>
                                               <a href="/DigitalAcademy/action/deletequiz.action?id=<%= qq.getId() %>&btn=<%= qq.getCtype() %>" style="color:blue">Delete</a>
