...
#top {
            background-image: url('https://designpickle-resources.s3.us-east-2.amazonaws.com/2020/Zoom+Backgrounds/April/20_DesignPickle_Zoom_Background-1.jpg');
            background-size: cover;
            background-position: center;
        }
    </style>
...
<section class="heading-page header-text" id="top">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2 style="color:#540303">Update Schedule</h2>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                    ...
                    <div class="col-lg-12">
                        <div class="meeting-single-item">
                            <div class="down-content" style="margin-top:-100px">
                               <h3 style="text-align:center">Update Schedule Form</h3>
                               <s:form id="f1" action="updateschedule" theme="simple">
                                <%
                                @SuppressWarnings("unchecked")
                                ArrayList<Schedule> clist = (ArrayList<Schedule>) session.getAttribute("schedulelist");
                                if (clist != null && !clist.isEmpty()) {
                                    String sname= request.getParameter("name");
                                    if (sname != null && !sname.isEmpty()) { 
                                        for (Schedule cc : clist) {
                                            if (cc.getName().equals(sname)) { 
                                		
                                %>
                               
                               <input type="hidden" name="btn" value="<%= cc.getName() %>">
                               	<table style="width:90%; margin-top:30px">
                               		<tr>
                               			<td>Name</td>
                               			<td><input type="text" name="name" class="txt" value="<%= cc.getName() %>" readonly style="color:#8a817f"></td>
                               			<td><s:fielderror fieldName="name" style="color:red"/></td>
                               		</tr>
                               		<tr>
                               			<td>Start_Date</td>
                               			<td><input type="text" name="start_date" class="txt" value="<%= cc.getStart_date() %>"></td>
                               			<td><s:fielderror fieldName="start_date" style="color:red"/></td>
                               		</tr>
                               		<tr>
                               			<td>End_Date</td>
                               			<td><input type="text" name="end_date" class="txt" value="<%= cc.getEnd_date() %>"></td>
                               			<td><s:fielderror fieldName="end_date" style="color:red"/></td>
                               		</tr>
                               		
                               		<tr>
                               			<td>Hour</td>
                               			<td><input type="text" name="hour" class="txt" value="<%= cc.getHour() %>"></td>
                               			<td><s:fielderror fieldName="hour" style="color:red"/></td>
                               		</tr>
                               		
                               		<tr>
                               			<td>Time zone</td>
                               			<td><input type="text" name="timezone" class="txt" value="<%= cc.getTimezone() %>" readonly style="color:#8a817f"></td>
                               			<td><s:fielderror fieldName="timezone" style="color:red"/></td>
                               		</tr>
                               		
                               		<tr>
                               			<td>Link</td>
                               			<td><input type="text" name="link" class="txt" value="<%= cc.getLink() %>"></td>
                               		...
                               		<tr>
                               			<td>Teacher Name</td>
                               			<td><input type="text" name="tname" class="txt" value="<%= cc.getTname() %>"></td>
                ...
                <div class="main-button-red">
                    <a href="/DigitalAcademy/view/adminviewschedule.jsp">Cancel </a>
                </div>
                </div>
            </div>
