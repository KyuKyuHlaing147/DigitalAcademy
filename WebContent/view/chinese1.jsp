                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12" >
                            <div class="main-button-red"  style="margin-left:85%; margin-top:50px;width:300px;height:60px;">
                                <a href="/DigitalAcademy/view/chinesehome2.jsp">Back to Chinese Course</a>
                            </div>
                        </div>
                    </div>
                     <div class="col-lg-6" style="margin-top:-100px">
                <img src="https://i.pinimg.com/736x/45/59/ca/4559cae17fa14c1df3f69c06f1863819.jpg" alt="Image" class="section-image" style="width: 100%; height: 680px;">
            </div>
                </div>
