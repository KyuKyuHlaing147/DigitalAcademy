...
<head>
    ...
    <style>
       #top {
            background-image: url('https://t4.ftcdn.net/jpg/03/01/77/91/360_F_301779119_k5UD83wtSAF3EEpMUudvH0f1fcNgVKD5.jpg ');
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="meeting-single-item">
                                ...
                                <div class="down-content" style="margin-top:-100px;">
                                  <h4>Frontend Web Technologies Course Content</h4>
                        ...
                        <div class="col-lg-12">
                            <div class="main-button-red" style="margin-left:75%; margin-top:50px;width:350px;height:60px;">
                                <a href="/DigitalAcademy/view/Fwthome2.jsp">Back to WebDesign Course</a>
                            </div>
                        </div>
                    </div>
                     <div class="col-lg-6" style="margin-top:-100px;">
                <img src="https://www.altexsoft.com/media/2020/01/word-image-67.png" alt="Image" class="section-image" style="width: 100%; height: 540px;">
            </div>
                </div>
