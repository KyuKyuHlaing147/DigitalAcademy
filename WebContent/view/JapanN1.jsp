                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="main-button-red" style="margin-left:85%; margin-top:50px;width:300px;height:60px;">
                                <a href="/DigitalAcademy/view/Japanhome2.jsp">Back to Japanese Course</a>
                            </div>
                        </div>
                    </div>
                     <div class="col-lg-6">
                <img src="${pageContext.request.contextPath}/assets2/images/japanchart.jpg" alt="Image" class="section-image" style="width: 100%; height: 745px; margin-top:-100px">
            </div>
                </div>
