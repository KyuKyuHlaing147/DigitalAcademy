...
public class Chinese6 extends ActionSupport {
    ...
    public String execute() throws IOException {
    	...
    	try {
			...
			String sql1="select * from progress where name=? and ctype='Chinese' and level='HSK 5'";
			...
			String sql="select * from content where ctype='Chinese' and level='HSK 6'";
