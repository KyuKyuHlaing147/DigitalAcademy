...
public class CInter extends ActionSupport {
    ...
    public String execute() throws IOException {
    	...
    	try {
			...
			String sql1="select * from progress where name=? and ctype='Object Oriented Programming' and level='basic'";
			...
			String sql="select * from content where ctype='Object Oriented Programming' and level='Intermediate'";
