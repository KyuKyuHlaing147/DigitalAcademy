...
public class Chinese2 extends ActionSupport {
    ...
    public String execute() throws IOException {
    	...
    	try {
			...
			String sql1="select * from progress where name=? and ctype='Chinese' and level='HSK 1'";
			...
			String sql="select * from content where ctype='Chinese' and level='HSK 2'";
