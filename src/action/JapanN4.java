...
public class JapanN4 extends ActionSupport {
    ...
    public String execute() throws IOException {
    	...
    	try {
			...
			String sql1="select * from progress where name=? and ctype='Japan' and level='N3'";
			...
			String sql="select * from content where ctype='Japan' and level='N4'";
