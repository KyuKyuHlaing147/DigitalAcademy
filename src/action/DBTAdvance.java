...
public class DBTAdvance extends ActionSupport {
    ...
    public String execute() throws IOException {
    	...
    	try {
			...
			String sql1="select * from progress where name=? and ctype='Database' and level='Intermediate'";
			...
			String sql="select * from content where ctype='Database' and level='Advance'";
