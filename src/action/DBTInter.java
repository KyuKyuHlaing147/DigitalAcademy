...
public class DBTInter extends ActionSupport {
    ...
    public String execute() throws IOException {
    	...
    	try {
			...
			String sql1="select * from progress where name=? and ctype='Database' and level='basic'";
			...
			String sql="select * from content where ctype='Database' and level='Intermediate'";
