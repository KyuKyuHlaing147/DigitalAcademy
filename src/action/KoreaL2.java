...
public class KoreaL2 extends ActionSupport {
...
public String execute() throws IOException {
    	...
    	try {
			...
			String sql1="select * from progress where name=? and ctype='Korea' and level='level1'";
			...
			String sql="select * from content where ctype='Korea' and level='level2'";
