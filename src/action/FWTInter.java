...
public class FWTInter extends ActionSupport {
    ...
    public String execute() throws IOException {
    	...
    	try {
			...
			String sql1="select * from progress where name=? and ctype='Frontend Web Technologies' and level='basic'";
			...
			String sql="select * from content where ctype='Frontend Web Technologies' and level='Intermediate'";
