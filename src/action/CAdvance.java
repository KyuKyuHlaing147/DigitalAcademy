...
public class CAdvance extends ActionSupport {
    ...
    public String execute() throws IOException {
    	...
    	try {
			...
			String sql1="select * from progress where name=? and ctype='Object Oriented Programming' and level='Intermediate'";
			...
			String sql="select * from content where ctype='Object Oriented Programming' and level='Advance'";
